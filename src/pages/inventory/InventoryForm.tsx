...
import { InventoryItem, InventoryFormData } from '../../shared/types/database';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const item: InventoryItem = {
        ...
        device_id: 'web-user' // Temporary device ID for now
      };

      await DatabaseService.addInventoryItem(item, false);

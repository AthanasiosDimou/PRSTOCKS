...
import { useDualTheme } from '../../shared/themes/DualThemeProvider';
import { DualDatabasePreferencesService, DevicePreferences } from '../../shared/services/DualDatabasePreferencesService';
...
export const DualSettingsPage: React.FC<SettingsPageProps> = ({ onBackToMain }) => {
  // =============================================================================
  // HOOKS AND STATE
  // =============================================================================
  const { 
  ...
  const handleSavePreferences = async () => {
    ...
    try {
      await DualDatabasePreferencesService.saveDevicePreferences(
  ...
  const handleBackupPreferences = async () => {
    ...
    try {
      await DualDatabasePreferencesService.backupDevicePreferences(username);
    ...
    <div className="settings-page dual-database" style={{ 
      ...
      <ThemeDrawer
        ...
        onThemeChange={() => {
          ...
          // Theme is automatically saved by the DualThemeProvider
        }}
      />
    </div>
  );
...
export { DualSettingsPage as SettingsPage };
